...
const struct mf_field mf_fields[MFF_N_IDS] = {
...

    {
        ...
        MFF_TUN_IVXLAN_SEPG, "tun_ivxlan_sepg", NULL,
        MF_FIELD_SIZES(be16),
        MFM_FULLY,
        MFS_DECIMAL,
        MFP_NONE,
        true,
        NXM_NX_TUN_IVXLAN_SEPG, "NXM_NX_TUN_IVXLAN_SEPG",
        NXM_NX_TUN_IVXLAN_SEPG, "NXM_NX_TUN_IVXLAN_SEPG", 0,
        OFPUTIL_P_NXM_OXM_ANY,
        OFPUTIL_P_NXM_OXM_ANY,
        -1,
    }, {
        MFF_TUN_IVXLAN_SPA, "tun_ivxlan_spa", NULL,
        MF_FIELD_SIZES(u8),
        MFM_FULLY,
        MFS_DECIMAL,
        MFP_NONE,
        true,
        NXM_NX_TUN_IVXLAN_SPA, "NXM_NX_TUN_IVXLAN_SPA",
        NXM_NX_TUN_IVXLAN_SPA, "NXM_NX_TUN_IVXLAN_SPA", 0,
        OFPUTIL_P_NXM_OXM_ANY,
        OFPUTIL_P_NXM_OXM_ANY,
        -1,
    }, {
...
mf_is_all_wild(const struct mf_field *mf, const struct flow_wildcards *wc)
{
    ...
    case MFF_TUN_IVXLAN_SPA:
        return !wc->masks.tunnel.ivxlan_spa;
    case MFF_METADATA:
             ...
             union mf_value *value)
{
    ...
    case MFF_TUN_IVXLAN_SEPG:
        ...
        break;
    case MFF_TUN_IVXLAN_SPA:
        value->u8 = flow->tunnel.ivxlan_spa;
        break;
    case MFF_TUN_TTL:
             ...
             const union mf_value *value, struct match *match)
{
    ...
    case MFF_TUN_IVXLAN_SEPG:
         ...
         break;
    case MFF_TUN_IVXLAN_SPA:
         match_set_tun_ivxlan_spa(match, value->u8);
         break;
    case MFF_TUN_TOS:
                  ...
                  const union mf_value *value, struct flow *flow)
{
    ...
    case MFF_TUN_IVXLAN_SEPG:
        ...
        break;
    case MFF_TUN_IVXLAN_SPA:
        flow->tunnel.ivxlan_spa = value->u8;
        break; 
    case MFF_TUN_TOS:
...
mf_set_wild(const struct mf_field *mf, struct match *match)
{
    ...
    case MFF_TUN_IVXLAN_SEPG:
        ...
        break;
    case MFF_TUN_IVXLAN_SPA:
        match_set_tun_ivxlan_spa_masked(match, 0, 0);
        break;
    case MFF_TUN_TOS:
       ...
       struct match *match)
{
    ...
    case MFF_TUN_IVXLAN_SEPG:
        ...
        break;
    case MFF_TUN_IVXLAN_SPA:
        match_set_tun_ivxlan_spa_masked(match, value->u8, mask->u8);
        break;
    case MFF_TUN_TTL:
